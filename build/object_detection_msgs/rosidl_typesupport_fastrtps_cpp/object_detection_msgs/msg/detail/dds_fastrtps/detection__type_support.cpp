...
#include "object_detection_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const object_detection_msgs::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  object_detection_msgs::msg::Detection & ros_message)
{
  // Member: x1
  cdr >> ros_message.x1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = object_detection_msgs::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const object_detection_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<object_detection_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  return &object_detection_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_detection_msgs, msg, Detection)() {
  return &object_detection_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
