...
def main():
  ...
  parser.add_argument("--pole_lat", type=float, required=True, help="Latitude of the competition pole")
  parser.add_argument("--pole_lon", type=float, required=True, help="Longitude of the competition pole")
  parser.add_argument("--pole_alt", type=float, required=True, help="Altitude/Height of the pole in meters - height to base")
